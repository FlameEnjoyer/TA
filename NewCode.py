...
# Ensure 'reactionsokafar.yaml' is in your working directory or provide a full path.
mechanism = 'reactionsokafar.yaml'
...
def main():
    ...
    output_filename = 'ammonia_combustion_results.csv'
